...
<section class="Contenido">
        <div class="orden">
            <div class="Primera_Impresion">
                <div class="contn">
                    ...
                    <h2 class="subtitulos">¿Qué es Tecnoparque?</h2>

                    <p class="parrafo">Es un programa y estrategia de innovación tecnológica del Servicio Nacional de Aprendizaje, creado para brindar apoyo en la materialización de proyectos de desarrollo tecnológico en prototipos funcionales y productos.</p>
                    <hr>
                    <p>Para Acceder a los servicios de Tecnoparque debes regístrate en la página oficial <a href="https://redtecnoparque.com/" target="_blank" rel="noopener noreferrer">www.redtecnoparque.com</a> y seguir los pasos del pdf <a href="documentos/PASO A PASO REGISTRO DE IDEAS TECNOPARQUE.pdf" download="PASO A PASO REGISTRO DE IDEAS TECNOPARQUE"><strong>“PASO A PASO REGISTRO DE IDEAS TECNOPARQUE”</strong></a></p>
                </div>
                    <div class="imagen">
        ...
        <div class="contenedor-esferas">
            <div class="esfera esfera-1">
                <h3 class="subtitulo">Objetivos de Tecnoparque.</h3>
                    <p class="p">Tecnoparque es un programa del SENA que tiene como objetivo principal promover el desarrollo de la innovación, la tecnología y la competitividad empresarial en Colombia.</p>
            </div>

            <div class="esfera esfera-2">
                <h3 class="subtitulo">¿Para quienes está dirigido el Tecnoparque?</h3>
                    <p class="p">El programa está dirigido a cada uno de los residentes en Colombia. El público interno incluye a aprendices, instructores o investigadores SENA, el público externo incluye a emprendedores empresarios, universitarios en pregrado, universitarios en posgrado y público general que necesitan apoyo de expertos y acceso a laboratorios especializados y equipos para materializar sus ideas.</p>
            </div>
           
            <div class="esfera esfera-3">
                <h3 class="subtitulo">Requisitos para ingresar a Tecnoparque</h3>
                    <ol class="l_ordenada">
                        <li>
            ...
            <div class="esfera esfera-4">
                <h3 class="subtitulo">Convenios de Tecnoparque</h3>
                    <p class="p">Tecnoparque suele tener convenios con universidades locales para proyectos de investigación, empresas relacionadas con el sector tecnológico para el desarrollo de productos o servicios y alianzas con entidades gubernamentales para capacitación y apoyo a emprendedores.</p>
            </div>
        </div>
        <div class="Contenedor">

            <div class="imagen">
                <img src="Img/TencoParque-img/logo _tecnoparque.png" alt="logo TecnoParque">
                </div>
            ...
            <div class="tarjetas-contenedor">
                ...
                <div class="tarjeta">
                    ...
                    <div class="contenido_tarjeta">
                        ...
                        <h2>¿Cuáles son los servicios que ofrece Tecnoparque?</h2>
                ...
                <div class="tarjeta">
                    ...
                    <div class="contenido_tarjeta">
                        ...
                        <h2>¿Qué beneficios se pueden obtener de los servicios que ofrecen?</h2>
