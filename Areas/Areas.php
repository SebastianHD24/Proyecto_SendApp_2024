    ...
    <div class="content__areas">
        ...
        <section class="areas__cards">
            ...
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/administracion/administracion.php">
                    <article>
            ...
            <!-- Card 2-->
            <div class="areas__cards-div">
                <a href="../../Proyecto_SendApp_2024/Biblioteca/Biblioteca.php"> 
                    <article>
            ...
            <!-- Card 3 -->
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/Bienestar/Bienestar.php">
                    <article>
            ...
            <!-- Card 4-->
            <div class="areas__cards-div">
                <a href="../../Proyecto_SendApp_2024/coordinaccion/coordinaccion.php">
                    <article>
                        <img src="Img/Cards-img/coordinacionverde.png" alt="Coordinación Académica Icono">
                    </article>
                    <article>
                        <div class="parrafos">
                            <hr>
            ...
            <!-- Card 5-->
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/FabricaSoftware/FabricaSoftware.php">
                    <article>
            ...
            <!-- Card 6 -->
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/fondoEmprender/fondoEmprender.php">
                    <article>
            ...
            <!-- Card 8 -->
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/relacionesCorporativas/relacionesCorporativas.php"> 
                    <article>
            ...
            <!-- Card 9 -->
            <div class="areas__cards-div">
                <a href="../../Proyecto_SendApp_2024/senova/senova.php"> 
                    <article>
            ...
            <!-- Card 10 -->
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/serviciosTecnologicos/serviciosTecnologicos.php">
                    <article>
            ...
            <!-- Card 11 -->
            <div class="areas__cards-div"> 
                <a href="../../Proyecto_SendApp_2024/TecnoAcademia/TecnoAcademia.php">
                    <article>
                        <img src="Img/Cards-img/TacademiaVerde.png" alt="Tecno Academia Icono">
                    </article>
                    <article>
                        <div class="parrafos">
                            <hr>
