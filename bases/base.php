...
<header id="main-header">
        ...
        <div class="resposive__menu">
            <nav class="resposive__menu-nav">
                <ul class="resposive__menu-ul">
                    <li><i class="fa-solid fa-house"></i><a href="#">Inicio</a></li>
                    <li><i class="fa-solid fa-user-group"></i><a href="#">Nostros</a></li>
                    <li><i class="fa-solid fa-cubes"></i><a href="#">Areas</a></li>
                    <li><i class="fa-solid fa-circle-info"></i><a href="#">Acerca CDITI</a></li>
                    <li> <i class="fa-solid fa-right-to-bracket"></i><a href="#">Ingreso</a></li>
                </ul>
            </nav>
