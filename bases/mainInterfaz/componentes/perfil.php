                    ...
                    <form method="POST" class="login__form datos_cuenta">
                        <div class="main-form">
                            <div class="first-section">
                                ...
                                <?php
                                    $rol = $row_user['id_rol'];
                                    $consulta = mysqli_query($conn, "SELECT * FROM roles WHERE id_rol = $rol AND LOWER(nombre_rol) = 'administrador'");
                                    $es_administrador = mysqli_num_rows($consulta) > 0;
                                    if ($es_administrador) :     
                                ?>
                                    <button type="button" class="btn-cambiar" id="btnCambiar">Cambiar Contraseña</button>
                                    <?php endif ?>

                                <div class="btn-actualizar"></div> 
                            </div>
