...
if ($id_rol == 3) {
    $sql = "UPDATE usuarios SET documento_identidad = '$nuevo_documento_identidad', nombres='$nombres', apellidos='$apellidos', celular='$celular', correo='$correo', ficha='$ficha', id_rol='$id_rol', id_servicio = 2 WHERE documento_identidad='$documento_identidad'"; 
} else {
    ...
    if ($id_servicio !== null) {
        ...
        if (mysqli_num_rows($check_result) > 0) {
            ...
            $sql = "UPDATE usuarios SET documento_identidad = '$nuevo_documento_identidad', nombres='$nombres', apellidos='$apellidos', celular='$celular', correo='$correo', ficha='$ficha', id_rol='$id_rol', id_servicio='$id_servicio' WHERE documento_identidad='$documento_identidad'";
        } else {
