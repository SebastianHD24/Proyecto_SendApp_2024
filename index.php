        ...
        <div class="panel bottom">
            <div class="content box-left-top">
                    <div class="description">
                        ...
                        <p class="TextSlipar1">Aprovecha la oportunidad de entrar a estudiar en el Sena CDITI, visualiza las convocatorias en nuestro apartado de áreas/Programa de formación. <br> Aqui encontrarás todas las convocatorias a los programas de formación que tenemos en nuestro centro. </p>
        ...
        <div class="panel top">
            <div class="content">
                <div class="description">
                    ...
                    <p class="TextSlipar2">Crea conexiones significativas y desafíate a ti mismo en cada paso del camino. <br>Aprende a interactuar con tus elementos, explora tus conocimientos y descubre tus habilidades.</p>
                </div>
    ...
    <div class="content">
        <section>
            <div class="content__parrafos-titulos">
                ...
                <h2>El sitio web oficial del Centro De Diseño e Innovación Tecnológica Industrial</h2>
            ...
            <div class="content__parrafos-links">
                <div class="p__container">
                    ...
                    <p>
                        En el menú de navagación en el apartado de <b><a href="Areas/Areas.php">Áreas</a></b> puedes encontrar la información referente a cada una de estas y sus respectivos servicios.</br>Ten en cuenta que algunos de estos servicios solo estan disponibles para las personas en calidad de <b>Aprendiz Sena.</b>
                    </p>
                </div>
                <div class="p__container">
                    <article>
                    ...
                    <p>
                        Si eres una persona natural en este sitio puedes encontrar todos los datos de contacto pertinentes sobre los funcionarios que atienden este centro de formación, solo ve al siguiente link y encontrarás todo la información necesaria en <b><a href="#Info-cditi">Acerca CDITI.</a></b>
                    </p>
                </div>
                <div class="p__container">
                    <article>
                ...
                <div class="p__container">
                    ...
                    <p>
                        Si eres aprendiz Sena y necesitas agendar una cita para algún servicio del Centro de Diseño e Innovación Tecnológica Industrial recuerda ingresar con tus datos de Sofia en <b><a href="../Proyecto_SendApp_2024/Login/login-aprendices/login.php">Ingreso.</a></b>
                    </p>
                </div>
            </div>
