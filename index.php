...
<?php include '../Proyecto_SendApp_2024/bases/header.php' ?> <!--Llamo el archivo donde se encuentra la estructura que quiero heredear-->
    ...
    <?php startblock('navegacion') ?> <!--Llamo el bloque de la barra de navegacion para sobre escribir las rutas-->
            <nav class="navbar">
                <!-- Logo sena -->
                ...
                <ul class="links">
                    ...
                    <li>
                        ...
                        <ul class="areas-mas">
                            ...
                            <li><a href="TecnoParque/index.php">Tecno parque</a></li>
                            <li><a href="TecnoAcademia/index.php">Tecno academia</a></li>
        ...
        <?php endblock() ?> <!--Fin del bloque barra de navegacion-->
