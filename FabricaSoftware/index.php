    ...
    <section class="Contenido">
        ...
        <div class="tarjeta" id="Tarjeta">
            ...
            <div class="contenido_tarjeta">
                ...
                <h2>¿Que es la frabrica de software?</h2>

                <p class="contenido-corto">En el corazón del centro de diseño e innovación tecnológica industrial, se encuentra la fábrica de software, un lugar donde la creatividad y la tecnología convergen para impulsar el progreso y la innovación.</p>

                <button class="leerMas" onclick="cambiarColor()">Leer más</button>

                <p class="contenido-expansivo">La fábrica de software no es solo un centro de desarrollo tecnológico, es un ecosistema dinámico que sirve como puente entre la educación y la industria, donde los aprendices del Sena tienen la oportunidad de transformar sus conocimientos en soluciones prácticas y tangibles.</p>

                <button class="leerMenos" style="display: none;" onclick="cambiarColor()">Leer menos</button>
        ...
        <div class="tarjeta">
            ...
            <div class="tarj-img">
                <img src="img/images (1).jpg " class="ima" >
            </div>
        ...
        <div class="tarjeta">
            ...
            <div class="tarj-img">
                <img src="img/portada_desarrollo.jpg" >
            </div>
